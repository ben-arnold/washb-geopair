...
knitr::kable(outtab %>% filter(country=="Bangladesh") %>% select(-country),
             digits = c(0,0,0,2,0,2,0,0,2),
             align = c("lcrcrcccc"),
             col.names = c("Outcome","Median age y (range)", "n","mean","n","mean","ATE (95% CI)*", "ICC (95% CI)†", "Moran's I"),
  ...
  add_header_above(c(" " = 2, "Control" = 2, "Nutrition" = 2, " "=3)) %>%
