...
```{r compare, fig.width = 8.5, fig.height = 3}
wt_eff_fig <- all_results %>% 
  ...
  scale_fill_manual(values = outcome_colors) +
  facet_wrap(.~country) +
  labs(x = "weighted relative efficiency (analytic)",
       y = "relative efficiency (model-based)",
       fill = "outcome group") +
  theme_minimal() +
  theme(legend.position = "bottom",
...
unwt_eff_fig <- all_results %>% 
  ...
  scale_fill_manual(values = outcome_colors) +
  facet_wrap(.~country) +
  labs(x = "unweighted relative efficiency (analytic)",
       y = "relative efficiency (model-based)",
       fill = "outcome group") +
  theme_minimal() +
  theme(legend.position = "bottom",
