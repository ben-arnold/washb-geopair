...
# Estimate 95% CIs for relative efficacy
...
```{r bootstrap CIs for relative efficacy}
#-------------------------------
...
# Relative efficacy across geographic scales
...
ggsave(here("output","washb-geopair-relative-efficacy-geographic-scale-smallreps.png"), plot_reff, device = "png", width = 8, height = 8)
```
...
ggsave(here("output","washb-geopair-relative-efficiency-geographic-scale.png"), plot_reff, device = "png", width = 8, height = 5)
```
# Session Info
```{r session info}
sessionInfo()
