...
estcomp_plot_k <-   ggplot(estcomp_res2 %>% filter(country=="Kenya")) + 
  ...
  annotate("text",label="subdistrict stratified",y=1.9,x=13, hjust=0.5, color="gray40") +
  labs(x = NULL, y = "relative efficiency compared to unmatched analysis",
       tag = "b") +
...
ggsave(here("output","washb-geopair-estimator-comparison.pdf"),plot_estcomp_composite,device="pdf",height=8,width=6.3)
```
