...
map_laz_diff <- ggplot(data=b_lazpred_diff) + 
  geom_sf(aes(color=pred_diff)) + 
  coord_sf(crs = 4326) +
  scale_color_gradient2(low=cbpal[2], mid="white", high=cbpal[3],limits = c(-1.2,1.05), 
  ...
  geom_point(data=dbgps, aes(x=lon,y=lat),pch=20,size=0.1,color="black") +
